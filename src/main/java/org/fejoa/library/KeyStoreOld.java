...
public class KeyStoreOld {
    ...
    static public KeyStoreOld create(FejoaContext context, String id, String password) throws IOException,
            CryptoException {
        StorageDir dir = context.getStorage(id);
        KeyStoreOld keyStore = new KeyStoreOld(context, dir);
        keyStore.create(password);
        return keyStore;
    }

    static public KeyStoreOld open(FejoaContext context, StorageDir dir, String password) throws IOException,
            CryptoException {
        KeyStoreOld keyStore = new KeyStoreOld(context, dir);
    ...
    private KeyStoreOld(FejoaContext context, StorageDir storageDir) throws IOException {
